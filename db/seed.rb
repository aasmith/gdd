def seed(db)
  # GDD Methods — per-crop base/cap from OSU Extension EM 9305
  ...
  # Crops — GDD values from OSU Extension EM 9305 appendix where available
  [
    ...
    # Hardy greens (base 40/86 — no OSU data, keeping previous estimates)
